...
HID_REPORT_DESCRIPTOR G_DefaultReportDescriptor[] = {
    ...
    /*
     * Codex-compatible transport framing implemented with reference to
     * GOROman/vibewatch, Copyright (c) 2026 GOROman, MIT License.
     * See THIRD_PARTY_LICENSES/GOROman-vibewatch-MIT.txt.
     */

...
typedef struct _DEVICE_CONTEXT
{
    ...
    HIDMINI_INPUT_REPORT    ReportQueue[CODEX_MICRO_QUEUE_CAPACITY];
    ULONG                   ReportHead;
    ULONG                   ReportTail;
    ULONG                   ReportCount;
...
//
#define HIDMINI_PID             CODEX_MICRO_PRODUCT_ID
#define HIDMINI_VID             CODEX_MICRO_VENDOR_ID
#define HIDMINI_VERSION         CODEX_MICRO_VERSION
